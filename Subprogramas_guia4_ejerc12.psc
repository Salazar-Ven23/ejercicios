   ...
   //como argumento el valor de "n" y que calcule la serie hasta llegar a ese valor.
	...
	Funcion numInicial <- suma(num1)
		Definir numInicial, numSiguiente, numSubsiguiente, i Como Entero
		numInicial = 0
		numSiguiente = 1
		numSubsiguiente = 0
		para i <- 1 Hasta num1
			Escribir "Cantidad de Veces  =   "  i
			Escribir numInicial ","
			numSubsiguiente=numInicial+numSiguiente
			numInicial=numSiguiente
			numSiguiente=numSubsiguiente
		FinPara
FinFuncion


Algoritmo Subprogramas_guia4_ejerc12
